...
for expt_id in exp_list:
    ...
    if run_fit:
        ...
        pickle.dump( ro.model_fit, open( fig_dirs['pkl_dir'] + expt_id +'_'+ro.activity+'_ols_reg_model_'+part+'_markers_all.pkl', "wb" ) )
    ...
    if run_circ:
        ...
        for n in range(n_perms):
            ...
            pickle.dump( ro.model_fit_shifted, open( fig_dirs['pkl_dir'] + expt_id +'_'+ro.activity+'_ols_reg_model_shifted_'+part+'_markers_all.pkl', "wb" ) )
