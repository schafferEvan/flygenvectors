...
dict_eval = copy.deepcopy(data_dict)
...
if part_i==0:
    ...
    pickle.dump( ro.model_fit, open( fig_dirs['pkl_dir'] + expt_id +'_'+ro.activity+'_ols_reg_model_'+part+'_4p0_all.pkl', "wb" ) )
...
if part_i==1:
    ...
    for n in range(n_perms):
        ...
        pickle.dump( ro.model_fit_shifted, open( fig_dirs['pkl_dir'] + expt_id +'_'+ro.activity+'_ols_reg_model_shifted_'+part+'_4p0_all.pkl', "wb" ) )
