...
ro.model_fit = ro.get_model_mle(initial_conds=initial_conds.copy())
pickle.dump( ro.model_fit, open( fig_dirs['pkl_dir'] + expt_id +'_'+ro.activity+'_ols_reg_model_'+part+'_3p0_TEST.pkl', "wb" ) )

# pdb.set_trace()
ro.evaluate_model(model_fit=ro.model_fit)
pickle.dump( ro.model_fit, open( fig_dirs['pkl_dir'] + expt_id +'_'+ro.activity+'_ols_reg_model_'+part+'_3p0_TEST.pkl', "wb" ) )
